...
export async function login(req, res) {
    ...
    try {
        ...
        res.status(200).send({ msg: "login succesful", id: account.id, department: account.department, company: account.company, name: account.name, token: token, excess: account.excess })
    }
